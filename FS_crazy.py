...
def plot_robot_pose_and_landmarks(robot_positions, landmarks_pose):
    ...
    plt.ylabel('Y')
    plt.legend()
    plt.savefig('SLAM_ci_'+str(err)+'_'+str(num_particles)+'.png')
    plt.clf()
...
def plot_poses_and_ellipses(landmarks_position, robot_positions, ParticleSet, ideal_positions, noisy_positions, land_list):
    ...
    plt.tight_layout()
    plt.savefig('SLAM_Ellipses_ci_'+str(err)+'_'+str(num_particles)+'.png')
    plt.clf()
...
def RSME_graphs(RSME_odom_list, RSME_slam_list,n_instances):
    ...
    plt.ylabel("RMSE(m)")
    plt.legend()
    plt.savefig('RMSE_ci_'+str(err)+'_'+str(num_particles)+'.png')
    plt.clf()
    ...
    plt.ylabel("RMSE(m)")
    plt.legend()
    plt.savefig('RMSE2_ci_'+str(err)+'_'+str(num_particles)+'.png')
    plt.clf()
