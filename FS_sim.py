...
r = 2
tot_time = 20
angular_vel=2*math.pi/tot_time #2*np.pi/290 #-2*n_turns*np.pi/tot_time #(rad/s)
linear_vel=r*math.sqrt(2*(1-math.cos(angular_vel*0.1)))/0.1 #28/290   #n_turns*r*np.pi/tot_time #(m/s)
precision=0.001
err=0.05
